...
NOTE: RUBERIC SHOWS THAT WE NEED TO CALCULATE A DISCRIMINANT FUNCTION, BUT I'M NOT SURE WHERE THAT FITS WITH ANSWERING THIS PROBLEM
...
With a Wilk's $\Lambda$ of _______ converted to an F statistic, we calculated a P-value of < .05 and reject the null hypothesis. 
